                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div
                            ...
                            <div class="d-flex">
                                <a href="{{ route('applicant_company_list') }}" class="btn btn-sm btn-gradient">
                        ...
                        <div class="card-body">
                            <div class="country-details-container">
                                ...
                                <section class="pb-4 text-center">
                                    <div class="container">
                                        <a href="{{ route('applicant_company_list') }}" class="btn btn-gradient btn-lg text-white border-0 d-inline-flex align-items-center gap-2"
                                            >
