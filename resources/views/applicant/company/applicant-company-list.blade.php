                    ...
                    <div class="card">
                       <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex items-center gap-2">
                                <a href="{{ route('applicant_company_list') }}" class="btn btn-sm glodex-blue-btn" id="addNewCountryBtn">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="glodex-show-entries">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            ...
                                            <!-- Show entries form -->
                                            <form method="GET" action="{{ route('search_applicant_company') }}" class="d-flex align-items-center gap-2">
                                            ...
                                            <!-- Search + Filter -->
                                            <form action="{{ route('search_applicant_company') }}" method="GET" class="d-flex align-items-center company-filter-form">
                                        ...
                                        <div class="university-card border rounded-4 shadow-md py-3 px-2 position-relative h-100">
                                            ...
                                            <div class="btn-group glodex-custom-3dot-dropdown position-absolute top-0 end-0 m-2">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('applicant_filter_job', [
                                                            'job_name' => '',
                                                    ...
                                                    <li><a class="dropdown-item" href="{{ route('applicant_company_details', $company->id) }}">Company Details</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="card-body-custom">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('applicant_filter_job', [
                                                            'job_name' => '',
                                                            'company_name' => $company->company_name,
                                                            'country_id' => '',
                                                            'search_terms' => '',
                                                            'job_type' => ''
                                                            ]) }}" class="btn btn-sm py-2 btn-gradient mt-3 d-inline-flex align-items-center">
