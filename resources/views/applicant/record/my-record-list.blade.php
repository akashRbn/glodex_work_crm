                                    ...
                                    <tbody>
                                        @foreach($applicants as  $applicant)
                                            <tr>
                                                <td>
                                                    <div class="dropdown position-relative">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="{{ route('edit_my_record', $applicant->id) }}" class="dropdown-item d-flex align-items-center gap-1" title="Login As">
                                                ...
                                                <td>
                                                    @if($applicant->createdBy && $applicant->createdBy->organization_name)
                                                        {{ $applicant->createdBy->organization_name }}
                                                    @else
                                                        Self Registered
                                                    @endif
                                                </td>
