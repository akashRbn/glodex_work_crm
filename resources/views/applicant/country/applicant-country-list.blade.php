                    ...
                    <div class="card">
                        <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex items-center gap-2">
                                <a href="{{ route('applicant_country_list') }}" class="btn btn-sm glodex-blue-btn" id="addNewCountryBtn">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="glodex-show-entries d-flex align-items-center justify-content-between flex-wrap gap-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <form method="GET" action="{{ route('search_applicant_countries') }}">
                                                <div class="d-flex align-items-center gap-2">
                                                ...
                                                @if (request()->has('search_applicant_countries'))
                                                    <input type="hidden" name="search_applicant_countries" value="{{ request('search_applicant_countries') }}">
                                                @endif
                                            <form>
                                        </div>
                                        <!-- Search form -->
                                        <form action="{{ route('search_applicant_countries') }}"  method="GET" class="d-flex align-items-center align-items-end">
                                            <div class="glodex-search-field d-flex align-items-center">
                                                <input type="search" name="search_applicant_countries" id="glodex-country-search" class="form-control form-control-sm mb-0" value="{{ request('search_applicant_countries') }}" placeholder="Search country...">
                                        ...
                                        <div class="glodex-country-list-item position-relative h-100 border rounded-4 shadow-sm p-2">
                                            <div class="btn-group glodex-custom-3dot-dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('search_applicant_company', ['country_id' => $country->id]) }}" target="_blank"><i class="ti ti-brand-abstract me-2"></i>Companies</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('applicant_filter_job', ['country_id' => $country->id]) }}" target="_blank">
                                                            <i class="ti ti-book-2 me-2"></i> Jobs
                                                        </a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="{{ route('applicant_country_details', $country->id) }}"><i class="ti ti-map-pin me-2"></i>Country Details</a></li>
                                                </ul>
                                            </div>
