                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex items-center gap-1">
                            <a href="{{ route('applicant_job_list') }}" class="btn btn-sm glodex-blue-btn" id="addNewCountryBtn">
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                <div class="glodex-show-entries d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    ...
                                    <form method="GET" action="{{ route('applicant_search_job') }}" class="d-flex align-items-center gap-2">
                                        ...
                                        <span>entries</span>
                                        <input type="hidden" name="applicant_search_job" value="{{ request('applicant_search_job') }}">
                                        <input type="hidden" name="search_country" value="{{ request('search_country') }}">
                                    </form>

                                    <!-- Search form -->
                                    <form action="{{ route('applicant_search_job') }}" method="GET" class="d-flex align-items-center align-items-end">
                                        <div class="glodex-search-field glodex-search-field-doble">
                                            ...
                                            <input type="search" name="search_job" id="glodex-job-search"
                                                ...
                                                value="{{ request('applicant_search_job') }}" placeholder="What Job are you looking for?">
                                        </div>
                                    ...
                                    <div class="course-list-card border position-relative">
                                        ...
                                        <div class="btn-group glodex-custom-3dot-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{ route('applicant_job_details', $job->id) }}"><i class="ti ti-map-pin me-2"></i>Job Details</a></li>
                                            </ul>
                                        </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="course_filterBtn" aria-labelledby="offcanvasRightLabel">
  ...
  <div class="offcanvas-body">
    <form action="{{ route('applicant_filter_job') }}" method="GET">
        <div class="mb-3">
