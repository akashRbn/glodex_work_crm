            ...
            <div class="row mt-2">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('update_applicant_profile') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label for="userName" class="form-label">Name<span class="text-danger">*</span>:</label>
                                        <input type="text" name="name" class="form-control" id="userName" placeholder="Enter your name" value="{{ old('name', $applicantUser->name) }}" />
                                        @error('name')
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="userPhone" placeholder="Enter your phone" value="{{ old('phone', $applicantUser->phone) }}" />
                                        @error('phone')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="email" class="form-control" id="userEmail" placeholder="Enter your email" value="{{ old('email', $applicantUser->email) }}" />
                                        @error('email')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" name="dob" class="form-control" id="userDob" value="{{ old('dob', $applicantUser->dob) }}" />
                                        @error('dob')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select id="maritalStatus" name="marital_status" class="form-select">
                                            ...
                                            <option value="1" {{ old('marital_status', $applicantUser->marital_status) == 1 ? 'selected' : '' }}>Single</option>
                                            <option value="2" {{ old('marital_status', $applicantUser->marital_status) == 2 ? 'selected' : '' }}>Married</option>
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select id="defaultSelect"  name="gender" class="form-select">
                                            ...
                                            <option value="1" {{ old('gender', $applicantUser->gender) == 1 ? 'selected' : '' }}>Male</option>
                                            <option value="2" {{ old('gender', $applicantUser->gender) == 2 ? 'selected' : '' }}>Female</option>
                                        </select>
                                        @error('gender')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="address" class="form-control" id="userAddress" placeholder="Enter your address" value="{{ old('address', $applicantUser->address) }}" />
                                        @error('address')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="photo-preview overflow-hidden shadow"
                                                ...
                                                <img id="profile_preview"
                                                    src="{{ isset($applicantUser) && $applicantUser->profile_photo && file_exists(public_path($applicantUser->profile_photo)) 
                                                        ? asset($applicantUser->profile_photo) 
    ...
    <script>
        function previewProfile(event) {
            ...
            if (file) {
                ...
                preview.src = '{{ isset($applicantUser) && $applicantUser->profile_photo ? asset($applicantUser->profile_photo) : "" }}';
                preview.style.display = '{{ isset($applicantUser) && $applicantUser->profile_photo ? "block" : "none" }}';
            }
        }
    </script>
@endpush
